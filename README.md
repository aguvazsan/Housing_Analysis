...
![Tex](.\data_mid_bootcamp_project_regression\MYSQL_Reports\Top_10.png)

- El precio promedio de las propiedades

![Tex](.\data_mid_bootcamp_project_regression\MYSQL_Reports\Average_price.png)

- El precio promedio de las propiedades en función a la cantidad de dormitorio

![Tex](.\data_mid_bootcamp_project_regression\MYSQL_Reports\Average_price_Bedrooms.png)

- El precio promedio de las propiedades en función a la cantidad de baños

![Tex](.\data_mid_bootcamp_project_regression\MYSQL_Reports\Average_price_Bathrooms.png)

- El precio promedio de las propiedades en función a la cantidad grado de conservación. 

![Tex](.\data_mid_bootcamp_project_regression\MYSQL_Reports\Average_price_Grade.png)

- El precio promedio de las propiedades en función las plantas. 

![Tex](.\data_mid_bootcamp_project_regression\MYSQL_Reports\Average_price_Floors.png)
...
![Tex](.\data_mid_bootcamp_project_regression\Images\correlation_1.png)
...
![Tex](.\data_mid_bootcamp_project_regression\Images\correlation_2.png)

Al contar con el Zipcode elimino las variables espaciales de Latitud y Longitud.

![Tex](.\data_mid_bootcamp_project_regression\Images\correlation_3.png)
...
![Tex](.\data_mid_bootcamp_project_regression\Images\Vif_1.png)
...
![Tex](.\data_mid_bootcamp_project_regression\Images\Vif_2.png)
...
![Tex](.\data_mid_bootcamp_project_regression\Images\Box_1.png)
...
![Tex](.\data_mid_bootcamp_project_regression\Images\Box_bedroom.png)

![Tex](.\data_mid_bootcamp_project_regression\Images\Box_bathrooms.png)

![Tex](.\data_mid_bootcamp_project_regression\Images\Box_lot.png)

![Tex](.\data_mid_bootcamp_project_regression\Images\Box_grade.png)

![Tex](.\data_mid_bootcamp_project_regression\Images\Box_long.png)

![Tex](.\data_mid_bootcamp_project_regression\Images\Box_lot15.png)
...
![Tex](.\data_mid_bootcamp_project_regression\Images\Tableau_1.png)
...
![Tex](.\data_mid_bootcamp_project_regression\Images\Tableau_2.png)
...
![Tex](.\data_mid_bootcamp_project_regression\Images\Tableau_5.png)
...
![Tex](.\data_mid_bootcamp_project_regression\Images\Tableau_4.png)
